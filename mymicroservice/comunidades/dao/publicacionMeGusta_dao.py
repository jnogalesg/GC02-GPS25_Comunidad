...
class PublicacionMeGustaDAO:
    ...
    @staticmethod
    def dar_megusta(publicacion: int, usuario: int) -> PublicacionMeGustaDTO:
        """
        ...
        try:
            ...
            raise Exception(f"La publicación {publicacion} no existe.")
        ...
        if not es_miembro:
             raise Exception(f"ACCESO DENEGADO: El usuario {usuario} no es miembro de esta comunidad.")
    ...
    @staticmethod
    def quitar_megusta(publicacion: int, usuario: int):
        """
        ...
        try:
            ...
            raise Exception(f"El usuario {usuario} no le ha dado 'Me Gusta' a la publicación {publicacion}.")
            
    @staticmethod
    def contar_likes(publicacion: int) -> int:
        """
    ...
    @staticmethod
    def get_likes_de_publicacion(publicacion: int) -> List[PublicacionMeGustaDTO]:
        """
